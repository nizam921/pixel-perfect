...
export const gmContent: Record<Lang, {
  ...
  AZ: {
    ...
    heroSlides: [
      ...
      { title: "VISA ilə ödəyin — 20% endirim", subtitle: "Bütün məhsullara VISA kartı ilə xüsusi endirim" },
    ],
  ...
  RU: {
    ...
    heroSlides: [
      ...
      { title: "Оплатите VISA — скидка 20%", subtitle: "Специальная скидка при оплате картой VISA на все товары" },
    ],
  ...
  EN: {
    ...
    heroSlides: [
      ...
      { title: "Pay with VISA — Get 20% Off", subtitle: "Exclusive discount on all products with VISA card" },
    ],
