...
// Shared i18n content for all pages
export const gmContent: Record<Lang, {
  ...
  AZ: {
    ...
    categories: { wines: "Şərablar", cheeses: "Pendirlər", meat: "Ət" },
  ...
  RU: {
    ...
    categories: { wines: "Вина", cheeses: "Сыры", meat: "Мясо" },
  ...
  EN: {
    ...
    categories: { wines: "Wines", cheeses: "Cheeses", meat: "Meat" },
